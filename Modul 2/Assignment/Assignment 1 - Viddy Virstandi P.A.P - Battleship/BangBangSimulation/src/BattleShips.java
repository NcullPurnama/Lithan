...
public class BattleShips {
    ...
    public static int[][] storedShip = new int [numRows][numCols];
        ...
        do {
            ...
            if ((x >= 0 && x < numRows) && (y >= 0 && y < numCols)) //valid guess
            {
                if (grid[x][y] == "x") //if computer ship is already there; computer loses ship
                {
                    ...
                    System.out.println("Oh no, you sunk your own ship. Too Stupid :(");
                    grid[x][y] = "x";
                ...
                System.out.println("You can't attack ships outside the " + numRows + " by " + numCols + " grid");
    ...
    public static void gameOver(){
        ...
        if(BattleShips.playerShips > 0 && BattleShips.computerShips <= 0)
            System.out.println("Hooray! You won the battle. Good work :)");
        else
            System.out.println("Oh no, you lost the battle. Better luck next life :(");
        System.out.println();
    }
