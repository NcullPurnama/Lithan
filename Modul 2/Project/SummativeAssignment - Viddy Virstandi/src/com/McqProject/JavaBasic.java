...
public class JavaBasic implements QuestionAnswer {
    ...
    public ArrayList importQuestion() {
        ...
        try {
            BufferedReader br = new BufferedReader(new FileReader("JavaBasicQuestion.csv"));
    ...
    public ArrayList importAnswer() {
        ...
        try {
            BufferedReader br = new BufferedReader(new FileReader("JavaBasicAnswer.csv"));
            while ((line = br.readLine()) != null) {
